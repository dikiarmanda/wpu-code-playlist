...
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCkXmLjEr95LVtGuIm3l2dPg&key=AIzaSyBqFGD13a1ZbU9wmhZSjDZxtoHPgBByTcQ');

$youtubeProfilePicture = $result['items'][0]['snippets']['thumbnails']['medium']['url'];
$channelName = $result['items'][0]['snippets']['title'];
$subscriber = $result['items'][0]['statistics']['subscriberCount'];

// Latest video
$result = get_CURL('https://www.googleapis.com/youtube/v3/search?key=AIzaSyBqFGD13a1ZbU9wmhZSjDZxtoHPgBByTcQ&channelId=UCkXmLjEr95LVtGuIm3l2dPg&maxResults=1&order=date&part=snippet');
$latestVideoId = $result['items'][0]['id']['videoId'];

// Instagram API
$clientld = 'f0b022fbe68c4ae79dd51169af18feb4';
